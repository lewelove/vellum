...
Discipline:
- All paths in `[scripts]` must be canonicalized by rust to strictly lie within `~/.config/vellum/` folder. This way we enforce dotfiles zen principle.
